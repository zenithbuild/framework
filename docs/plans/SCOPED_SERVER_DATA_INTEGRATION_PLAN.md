...
|-------|--------|--------|-------|
| #95 | `docs/component-server-values-architecture-lock` | pr-open | Doc-only architecture lock; closes via PR merge |
| #96 | `feature/component-server-values-owner-scanner` | pending | Blocked until #95 merged |
