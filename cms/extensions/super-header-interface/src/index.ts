				...
				options: {
					fields: [
						...
						},
						{
							field: 'hideWhenField',
							type: 'string',
							name: 'Hide When Field',
							meta: {
								width: 'half',
								interface: 'input',
								note: 'Optional root-level item field name. Hide this action when that field matches the configured value.',
								options: {
									font: 'monospace',
									placeholder: 'source_kind',
								},
							},
						},
						{
							field: 'hideWhenValue',
							type: 'string',
							name: 'Hide When Value',
							meta: {
								width: 'half',
								interface: 'input',
								note: 'Value that hides the action when the selected root field matches it exactly.',
								options: {
									font: 'monospace',
									placeholder: 'repo_sync',
								},
							},
						},
					],
